...
## SiteSettings
Модель `SiteSettings` предназначена для хранения глобальных настроек сайта. Включает следующие поля:

- **head_title**: Заголовок страницы (title)
- **main_title**: Главный заголовок сайта
- **child_massage_title**: Заголовок раздела детского массажа
- **massage_title**: Заголовок раздела массажа
- **about_title**: Заголовок раздела "Обо мне"
- **contact_title**: Заголовок раздела контактов
- **career_start_year**: Год начала практики массажа
